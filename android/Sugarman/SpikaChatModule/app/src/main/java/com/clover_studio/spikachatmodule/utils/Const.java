...
//        public static final String BASE_URL = "http://52.91.91.133/spika/v1/"; //production url
        public static final String BASE_URL = "https://sugarman-spika.herokuapp.com/spika/v1/"; //new server url
...
//        public static final String SOCKET_URL = "http://52.91.91.133/spika"; //test url
    public static final String SOCKET_URL = "https://sugarman-spika.herokuapp.com/spika"; //new server url
    }
    ...
    public static final class EmitKeyWord{
        ...
        public static final String NOT_OPENED_MESSAGE = "notOpenedMsg";
    ...
    public static final class RequestCode{
        ...
        public static final int PHOTO_CHOOSE = 9;
