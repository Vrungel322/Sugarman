...
public class CustomPicasso extends Picasso {
  ...
  CustomPicasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
      RequestTransformer requestTransformer, List<RequestHandler> extraRequestHandlers, Stats stats,
      Bitmap.Config defaultBitmapConfig, boolean indicatorsEnabled, boolean loggingEnabled) {
    super(context, dispatcher, cache, listener, requestTransformer, extraRequestHandlers, stats,
  ...
  @Override public RequestCreator load(String path) {
    if (path == null) {
  ...
  public static class Builder {
    ...
    public CustomPicasso build() {
      ...
      return new CustomPicasso(context, dispatcher, cache, listener, transformer, requestHandlers,
