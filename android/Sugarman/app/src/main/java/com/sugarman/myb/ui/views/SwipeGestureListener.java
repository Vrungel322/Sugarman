...
public class SwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
  ...
  private final WeakReference<OnSwipeListener> swipeListener;

  public SwipeGestureListener(OnSwipeListener swipeListener) {
    this.swipeListener = new WeakReference<>(swipeListener);
  }
  ...
  private boolean onSwipe(Direction direction) {
    if (swipeListener.get() != null) {
      swipeListener.get().onSwipe(direction);
    }
    return false;
  }
