...
public class InviteForRescueActivity extends BaseActivity
      ...
      new FacebookCallback<GameRequestDialog.Result>() {
        ...
        @Override public void onError(FacebookException error) {
          if (DeviceHelper.isNetworkConnected()) {
            new SugarmanDialog.Builder(InviteForRescueActivity.this,
    ...
    if (checkCallingOrSelfPermission(Constants.READ_PHONE_CONTACTS_PERMISSION)
      ...
      AsyncTask.execute(() -> {
        HashMap<String, String> contactList =
            ContactsHelper.getContactList(InviteForRescueActivity.this);
  ...
  @OnClick(R.id.fb_filter) public void showFbFriends() {
    if (isFbLoggedIn) {
      ...
      AlertDialog.Builder builder = new AlertDialog.Builder(InviteForRescueActivity.this);
      ...
      builder.setPositiveButton(R.string.OK, new DialogInterface.OnClickListener() {
        public void onClick(DialogInterface dialog, int id) {
          Intent intent = new Intent(InviteForRescueActivity.this, EditProfileActivity.class);
