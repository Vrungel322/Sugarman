...
public class DataManager {
  ...
  public Observable<List<ShopProductEntity>> fetchProducts(List<String> productName) {
    ...
    entities.add(new ShopProductEntity("2", productName.get(2), "", "10",
        Arrays.asList(String.valueOf(R.drawable.com_5), String.valueOf(R.drawable.com_1),
            String.valueOf(R.drawable.com_2), String.valueOf(R.drawable.com_3),
            String.valueOf(R.drawable.com_4))));
  ...
  public Observable<Response<Object>> declineRequest(String inviteId) {
    return mRestApi.declineRequest(inviteId);
  }
